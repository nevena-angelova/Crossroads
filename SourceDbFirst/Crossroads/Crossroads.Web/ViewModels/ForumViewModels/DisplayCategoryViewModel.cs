...
namespace Crossroads.Web.ViewModels.ForumViewModels
{
    public class DisplayCategoryViewModel : IMapFrom<Category>, IHaveCustomMappings
    {
        ...
        public ICollection<Role> LastTopicAuthorRoles { get; set; }
        ...
        public ICollection<Role> CategoryLastAnswerAuthorRoles { get; set; }
        ...
        public void CreateMappings(IConfiguration configuration)
        {
            configuration.CreateMap<Category, DisplayCategoryViewModel>()
                ...
                .ForMember(m => m.LastTopicAuthor, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateCreated).FirstOrDefault().User.UserName))
                .ForMember(m => m.LastTopicAuthorRoles, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateCreated).FirstOrDefault().User.Roles))
                .ForMember(m => m.LastTopicAuthorImage, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateCreated).FirstOrDefault().User.Image))
                ...
                .ForMember(m => m.CategoryLastAnswerAuthor, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateUpdated).FirstOrDefault()
                        .Answers.OrderByDescending(a => a.DateCreated).FirstOrDefault().User.UserName))
                .ForMember(m => m.CategoryLastAnswerAuthorRoles, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateUpdated).FirstOrDefault()
                        .Answers.OrderByDescending(a => a.DateCreated).FirstOrDefault().User.Roles))
                .ForMember(m => m.CategoryLastAnswerAuthorImage, opt =>
                    opt.MapFrom(c => c.Topics.OrderByDescending(t => t.DateUpdated).FirstOrDefault()
                        .Answers.OrderByDescending(a => a.DateCreated).FirstOrDefault().User.Image))
