...
namespace Crossroads.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(ICrossroadsData data) : base(data)
        {
        }

        public AccountController(ICrossroadsData data, ApplicationUserManager userManager, ApplicationSignInManager signInManager) : base(data)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new User { UserName = model.UserName, Email = model.Email, LastActionTime = DateTime.Now };
